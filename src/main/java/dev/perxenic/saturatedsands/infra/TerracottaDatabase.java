...
public class TerracottaDatabase {
    ...
    static {
        ...
        TERRACOTTA_DYES.put("beige", new TerracottaDye(
                ...
                BlockTags.create(cLoc("dyed/beige")),
                SSItemTags.Color.BEIGE,
        ...
        TERRACOTTA_PATTERNS.put("bird", new TerracottaPattern(
                SSItemTags.Pattern.BIRD,
                SSBlockTags.Pattern.BIRD,
                SSTerracotta.registerFadedTerracotta(SSTerracotta.BLOCKS, SSTerracotta.ITEMS, "bird")
        ));
        TERRACOTTA_PATTERNS.put("knot", new TerracottaPattern(
                SSItemTags.Pattern.KNOT,
